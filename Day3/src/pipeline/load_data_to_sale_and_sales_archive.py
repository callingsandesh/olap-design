...
#importing connection of databases
from src.utils import connect_to_sales_raw
from src.utils import connect_to_sales_archive
...
def load_sales_to_sales_archive():
    ...
    SELECT * FROM sales
    """
    data=execute_select_query(query,connect_to_sales_raw())
    ...
    """
    execute_insert_query(query_1,connect_to_sales_archive(),data)
...
def load_data_to_sales_raw_and_archive():
    ...
    execute_delete_query(query,connect_to_sales_raw())
    ...
    execute_insert_query(query,connect_to_sales_raw(),data)
